//======== Copyright Project Absynthe (DnG Software), All rights reserved. =============//
//
// Purpose: Take all default shaders and convert them to ones used by Insolence.
//			Based on the hot dogshit that Biohazard/Sandern did.
//
// Authored by Graham Dianaty, fixed and modified for Insolence.
//
//======================================================================================//
...
CON_COMMAND(ay_matsys_spewtables, "")
{
...
static const char * const pszShaderReplaceDict[][2] = {
	...
	// In the event of extremely broken nonense, overwrite to default shaders for testing:
	"VertexLitGeneric_OVERWRITE"		"VertexLitGeneric",
	"LightmappedGeneric_OVERWRITE"		"LightmappedGeneric"
};
