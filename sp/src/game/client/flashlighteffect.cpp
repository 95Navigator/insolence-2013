...
ConVar r_flashlightoffsetx( "r_flashlightoffsetright", "10.0", FCVAR_CHEAT );
ConVar r_flashlightoffsety( "r_flashlightoffsetup", "-20.0", FCVAR_CHEAT );
ConVar r_flashlightoffsetz( "r_flashlightoffsetforward", "24.0", FCVAR_CHEAT );
