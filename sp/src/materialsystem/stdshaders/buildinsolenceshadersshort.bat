...
%BUILD_SHADER% stdshader_dx9_20b_short		-game %GAMEDIR% -source %SOURCEDIR%
%BUILD_SHADER% stdshader_dx9_30_short		-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30 

%BUILD_SHADER% insolence_dx9_20b		-game %GAMEDIR% -source %SOURCEDIR%
%BUILD_SHADER% insolence_dx9_30			-game %GAMEDIR% -source %SOURCEDIR% -dx9_30	-force30 
