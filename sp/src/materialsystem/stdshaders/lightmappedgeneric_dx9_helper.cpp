...
ConVar mat_force_lightmapped_phong_boost( "mat_force_lightmapped_phong_boost", "1.0", FCVAR_CHEAT );
ConVar mat_force_lightmapped_phong_exp( "mat_force_lightmapped_phong_exp", "5.0", FCVAR_CHEAT );
										 ...
										 CBasePerMaterialContextData **pContextDataPtr )
{
	...
	if ( !IsX360() && !r_flashlight_version2.GetBool() )
	{
